class Stacker {
  ...
  getGoldCoordinates = function (cell) {
  ...
  setStairLocations = function (cell) {
  ...
  addBlocksToAllStairs = function (cell) {
  ...
  goToRandomDirection = function (cell) {
